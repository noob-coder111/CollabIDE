export default {
  cpp: `// Team Ctrl+Alt+Elite : IDE+ (A Collaborative Online IDE)
...
`,
  java: `// Team Ctrl+Alt+Elite : IDE+ (A Collaborative Online IDE)
...
`,
  py: `# Team Ctrl+Alt+Elite : IDE+ (A Collaborative Online IDE)
